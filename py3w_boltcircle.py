...
import math
from tkinter import * #python 3 to many
from tkinter import messagebox #python 3
import os
import sys


#IN_AXIS = os.environ.has_key("AXIS_PROGRESS_BAR") #Windows standalone
...
class Application(Frame):
    ...
    def GenCode(self, event):
        ...
        while (count < no_of_holes):
            ...
            x=(x1+x_center)*scale
            y=(y1+y_center)*scale
            z=(z_center)*scale#self.g_code.insert(END,(self.Gcode_value.get()))
